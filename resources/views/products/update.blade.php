                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <!-- <form class="form-horizontal" action="/product/update/{{ $product["id"] }}" method="PUT" enctype="multipart/form-data"> -->
                            {!! Form::model($product, array('url'=>'product/update/' . $product["id"], 'class'=>'form-horizontal', 'files' => true, 'method'=>'PUT')) !!}
                                ...
                                <div class="box-body">
                                    <div class="col-md-8">
                                        ...
                                        <div class="panel" style="padding: 0px 15px 15px 15px">
                                            ...
                                            <textarea class="form-control" name="body_html" style="border:0px;">{{ $product["body_html"] }}</textarea>
                                        </div><!-- .panel -->
                                ...
                                <div class="btn-actions">
                                    <button type="submit" class="btn btn-danger pull-left">Delete product</button>
